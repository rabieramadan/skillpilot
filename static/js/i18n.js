...
const translations = {
    en: {
        ...
        // --- auto-added missing translations (mirrors inline HTML fallbacks) ---
        add_outcome: "Add outcome",
        add_week: "Add week",
        apply: "Apply",
        atrisk_h: "At-risk learners",
        audience_label: "Target audience",
        back: "Back",
        back_threads: "Back to threads",
        ...
        copy: "Copy",
        course: "Course",
        course_label: "Course ID (optional)",
        description: "Description",
        drafts_heading: "My drafts",
        edit_student: "Edit Student",
        empty: "No learners are linked to your account yet.",
        empty_hint: "Ask your child to share a guardian link request, then approve it from their account.",
        export_btn: "Export &amp; download",
        export_h: "Export a course as SCORM",
        export_help: "Bundle a course's weeks and materials into a downloadable SCORM ZIP.",
        factors: "Factors",
        file_label: "SCORM ZIP file",
        files_in_chat: "Files in this chat",
        filter_cohort: "Cohort ID",
        filter_course: "Course ID",
        forgot_password: "Forgot Password?",
        generate: "Generate outline",
        generating: "Generating...",
        heatmap_h: "Weekly heatmap",
        input_text: "Input Text",
        label_learner_id: "Learner user ID",
        ...
        learner: "Learner",
        level: "Level",
        link_hint: "Enter the learner's user ID to request a link. Share the consent token with them so they can approve from their account.",
        link_title: "Link a learner",
        manifest_title: "Manifest",
        menu_ai_tools: "AI Tools",
        menu_authoring: "Course Authoring",
        menu_insights: "Insights and Analytics",
        menu_community: "Community Forum",
        menu_guardian: "Parent and Guardian",
        menu_links: "Useful Links",
        menu_integrations: "Integrations",
        menu_admin_users: "Manage Users",
        menu_admin_courses: "Manage Courses",
        menu_admin_enrollments: "Enrollments",
        menu_admin_exams: "Exams",
        menu_admin_surveys: "Surveys",
        menu_admin_certificates: "Certificates",
        menu_admin_ai_models: "Artificial Intelligence Models",
        menu_admin_settings: "Site Settings",
        menu_admin_freeze: "Freeze Platform",
        menu_admin_system: "System Administration",
        menu_cat_ai: "Artificial Intelligence",
        menu_cat_learning: "Learning",
        menu_cat_teaching: "Teaching",
        menu_cat_account: "Account",
        menu_cat_admin: "Administration",
        menu_cat_content: "Content Management",
        menu_cat_people: "People",
        menu_cat_platform: "Platform",
        name: "Name",
        nav_app: "App",
        nav_authoring: "Authoring",
        ...
        next: "Next",
        no_chats_yet: "No previous chats yet",
        no_course: "— Create a new course on import —",
        no_courses: "No courses available",
        no_files_attached: "No files attached",
        outcomes: "Learning outcomes",
        output_language: "Output Language:",
        password_reset_success: "Password Reset Successfully",
        perm_attendance: "View attendance",
        perm_ethics: "View EthicSense",
        perm_grades: "View grades",
        perm_message: "Message instructors",
        pkg_h: "Recent packages",
        post: "Post thread",
        proctoring_consent: "I consent to the signals above",
        proctoring_intro: "We tell you exactly what we look at. We never collect camera, microphone, face, biometric, keystroke timing, or mouse-tracking data.",
        proctoring_opt_out: "Opt out (accommodation — no signals will be recorded)",
        proctoring_title: "Transparent Proctoring",
        publish: "Publish to course",
        rank: "Rank",
        ...
        result: "Result",
        retention_checks_desc: "Quick refreshers for skills you've already mastered. Take a short quiz to keep them sharp — your skill confidence updates immediately.",
        retention_checks_title: "Retention Checks",
        retry_btn: "Retry failed",
        scan: "Scan now",
        score: "Score",
        score_h: "Quality score",
        ...
        title_ar_label: "Course title (Arabic)",
        title_label: "Course title (English)",
        token_label: "Share this consent token with the learner:",
        tool_activity: "Activity Generator",
        tool_activity_desc: "Create learning activities",
        tool_announcement: "Announcement Creator",
        tool_announcement_desc: "Create announcements",
        tool_compliance: "Compliance Checker",
        tool_compliance_desc: "Check compliance standards",
        tool_course_desc: "Course Description",
        tool_course_desc_desc: "Write course descriptions",
        tool_data: "Data Analyzer",
        tool_data_desc: "Analyze data and extract insights",
        tool_differentiation: "Differentiation Tool",
        tool_differentiation_desc: "Adapt content for different levels",
        tool_email: "Email Composer",
        tool_email_desc: "Compose professional emails",
        tool_feedback: "Feedback Generator",
        tool_feedback_desc: "Generate student feedback",
        tool_grammar: "Grammar Checker",
        tool_grammar_desc: "Check and improve writing style",
        tool_lesson_planner: "Lesson Planner",
        tool_lesson_planner_desc: "Create detailed lesson plans",
        tool_meeting: "Meeting Minutes",
        tool_meeting_desc: "Generate meeting minutes",
        tool_motivation: "Motivation Coach",
        tool_motivation_desc: "Get study motivation tips",
        tool_paraphraser: "Paraphraser",
        tool_paraphraser_desc: "Rewrite text with different tones",
        tool_policy: "Policy Writer",
        tool_policy_desc: "Draft policy documents",
        tool_practice_quiz: "Practice Quiz",
        tool_practice_quiz_desc: "Generate practice quizzes",
        tool_presentation: "Presentation Creator",
        tool_presentation_desc: "Create presentation outlines",
        tool_question_gen: "Question Generator",
        tool_question_gen_desc: "Generate exam questions using Bloom's Taxonomy",
        tool_report: "Report Generator",
        tool_report_desc: "Generate analytics reports",
        tool_rubric: "Rubric Creator",
        tool_rubric_desc: "Create grading rubrics",
        tool_simplifier: "Content Simplifier",
        tool_simplifier_desc: "Simplify complex topics",
        tool_summarizer: "Text Summarizer",
        tool_summarizer_desc: "Condense documents into key points",
        tool_text_generator: "Text Generator",
        tool_text_generator_desc: "Generate creative, professional, or academic text",
        tool_translator: "Smart Translator",
        tool_translator_desc: "Translate between languages",
        topic_label: "Topic / theme",
        upload_btn: "Upload package",
        upload_h: "Import a SCORM package",
        upload_help: "Upload a SCORM 1.2 or 2004 ZIP.",
        upload_material: "Upload Course Material",
        use_ai: "Use AI to draft a starting outline",
        username: "Username",
        version_label: "SCORM version",
        weeks_h: "Weekly modules",
        weeks_label: "Number of weeks",
        xapi_h: "Recent xAPI statements",
        xapi_help: "Statements you have emitted and their delivery status.",
        xp: "XP",
    },
    ...
    ar: {
        ...
        // --- auto-added missing translations (English fallback; replace with Arabic) ---
        add_outcome: "Add outcome",
        add_week: "Add week",
        apply: "Apply",
        atrisk_h: "At-risk learners",
...
class I18n {
    ...
    translatePage() {
        ...
        document.querySelectorAll('[data-i18n]').forEach(element => {
            ...
            // Safety net: when the i18n system can't find the key in either
            // language, t() returns the raw key (e.g. "tool_text_generator").
            // Never let that raw key visibly replace the human-readable
            // fallback text the template author put inside the element.
