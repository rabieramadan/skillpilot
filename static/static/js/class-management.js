    ...
    async viewExamResults(examId, examTitle) {
        try {
            ...
            let resultsHtml = data.results.length === 0 
                ...
                : data.results.map(r => `
                    <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px; background: ${r.passed ? '#f0fdf4' : '#fef2f2'}; border-radius: 6px; margin-bottom: 8px;" data-testid="result-row-${r.id}">
                        <div>
            ...
            modal.innerHTML = `
                <div style="background: white; padding: 24px; border-radius: 12px; max-width: 700px; width: 95%; max-height: 80vh; overflow-y: auto;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        ...
                        <button onclick="document.getElementById('examResultsModal').remove()" style="background: none; border: none; font-size: 24px; cursor: pointer;">&times;</button>
                    </div>
